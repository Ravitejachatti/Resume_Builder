...
import { ResumeTemplate1, ResumeTemplate2, ResumeTemplate3, ResumeTemplate4, ResumeTemplate5 } from "./resumeTemplate"; // Ensure correct import
  ...
  "workExperience": [
    {
      ...
      "duration": "6 months",
      "responsibilitiesAndAchievements": "Developed a web-based attendance system using MERN stack.",
...
const ResumeBuilder = () => {
  ...
  const templates = {
    ...
    template3: <ResumeTemplate3 studentData={studentData} />,
    template4: <ResumeTemplate4 studentData={studentData} />,
    template5: <ResumeTemplate5 studentData={studentData} />
  };
  useEffect(() => {
  ...
  return (
    <div className="container mx-auto p-5">
      ...
      <label className="block mb-3 font-semibold">Choose a Resume Template:</label>
      <select
